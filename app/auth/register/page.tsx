      ...
      <div className="w-full max-w-md space-y-8 rounded-lg border border-ansa-accent/20 bg-white p-8 shadow-lg">
        ...
        <form onSubmit={handleRegister} className="space-y-6">
          ...
          <div>
            <label
              htmlFor="fullName"
              className="block text-sm font-medium text-ansa-primary"
            >
              Full Name
            </label>
            <input
              ...
              className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-ansa-primary shadow-sm focus:border-ansa-accent focus:outline-none focus:ring-1 focus:ring-ansa-accent"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-ansa-primary shadow-sm focus:border-ansa-accent focus:outline-none focus:ring-1 focus:ring-ansa-accent"
            >
              <option value="parent">Parent (view my child&apos;s progress)</option>
              <option value="player">Player (track my own progress & goals)</option>
              <option value="coach">Coach (run sessions & log progress)</option>
            </select>
          </div>
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <Link
            href="/auth/login"
            className="font-medium text-ansa-accent hover:underline"
          >
            Sign in
          </Link>
        </p>
